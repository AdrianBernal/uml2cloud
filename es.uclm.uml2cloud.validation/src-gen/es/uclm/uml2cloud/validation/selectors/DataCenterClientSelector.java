 ...
 * @generated
 */
public class DataCenterClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "DataCenter"); //$NON-NLS-1$
	}
}
