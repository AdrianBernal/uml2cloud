 ...
 * @generated
 */
public class ResponseOfferedVMsClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "ResponseOfferedVMs"); //$NON-NLS-1$
	}
}
