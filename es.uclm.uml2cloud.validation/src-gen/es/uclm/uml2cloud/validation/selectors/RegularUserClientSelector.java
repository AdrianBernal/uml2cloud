 ...
 * @generated
 */
public class RegularUserClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "RegularUser"); //$NON-NLS-1$
	}
}
