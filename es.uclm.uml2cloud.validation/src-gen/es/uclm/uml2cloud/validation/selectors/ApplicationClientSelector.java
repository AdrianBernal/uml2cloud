 ...
 * @generated
 */
public class ApplicationClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "Application"); //$NON-NLS-1$
	}
}
