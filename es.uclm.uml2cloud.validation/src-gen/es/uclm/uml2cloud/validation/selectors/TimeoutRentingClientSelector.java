 ...
 * @generated
 */
public class TimeoutRentingClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "TimeoutRenting"); //$NON-NLS-1$
	}
}
